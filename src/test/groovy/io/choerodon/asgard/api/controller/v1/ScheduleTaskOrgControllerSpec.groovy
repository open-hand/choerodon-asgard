...
class ScheduleTaskOrgControllerSpec extends Specification {
    public static final String BASE_PATH = "/v1/schedules/organizations/1/tasks"
    @Autowired
    TestRestTemplate restTemplate

    @Autowired
    private ScheduleTaskOrgController scheduleTaskController
