...
class ScheduleTaskInstanceProjectControllerSpec extends Specification {
    public static final String BASE_PATH = "/v1/schedules/projects/1/tasks/instances"
    @Autowired
    TestRestTemplate restTemplate
    @Autowired
    private ScheduleTaskInstanceProjectController scheduleTaskInstanceController
