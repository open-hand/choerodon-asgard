...
class ScheduleMethodOrgControllerSpec extends Specification {
    public static final String BASE_PATH = "/v1/schedules/organizations/1/methods"
    @Autowired
    TestRestTemplate restTemplate

    @Autowired
    private ScheduleMethodOrgController scheduleMethodController
    ...
    def "PagingQuery"() {
        ...
        def entity = restTemplate.getForEntity(BASE_PATH, Page, queryParams, pageRequest)
        then: '状态码正确；方法参数调用成功'
