...
class QuartzRealJobServiceSpec extends Specification {
    ...
    def "TriggerEvent"() {
        ...
        new QuartzTaskInstance(id: 1L, status: "RUNNING")                                                 | null       | null                                                                                                                                                     | null                               | 0
        null                                                                                              | new Date() | new QuartzTask(status: "DISABLE")                                                                                                                        | null                               | 0
        null                                                                                              | new Date() | new QuartzTask(status: "ENABLE", executeMethod: "method")                                                                                                | null                               | 0
        null                                                                                              | new Date() | new QuartzTask(status: "ENABLE", executeMethod: "method", name: "name", executeParams: "", triggerType: "cron-trigger", cronExpression: "0/1 * * * * ?") | new QuartzMethod(maxRetryCount: 1) | 0
        new QuartzTaskInstance(status: "COMPLETED", actualStartTime: new Date(), executeResult: "result") | new Date() | new QuartzTask(status: "ENABLE", executeMethod: "method", name: "name", executeParams: "", triggerType: "cron-trigger", cronExpression: "0/1 * * * * ?") | new QuartzMethod(maxRetryCount: 1) | 1
