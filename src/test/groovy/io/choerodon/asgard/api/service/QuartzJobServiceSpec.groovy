...
import io.choerodon.asgard.api.service.impl.QuartzJobServiceImpl
...
class QuartzJobServiceSpec extends Specification {
    ...
    def "AddJob"() {
        given: "参数准备"
        def cronTask = new QuartzTask(id: 1L, name: "name", startTime: new Date(), endTime: new Date(), triggerType: "cron-trigger", cronExpression: "0/1 * * * * ?")
        and: "mock"
    ...
    def "AddJob[Exception]"() {
        given: "参数准备"
        def simpleTask = new QuartzTask(id: 1L, name: "name", startTime: null, endTime: new Date(), triggerType: "simple-trigger", simpleRepeatCount: 5, simpleRepeatInterval: 10L, simpleRepeatIntervalUnit: "SECONDS")
        and: "mock"
