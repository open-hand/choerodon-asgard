...
class SagaTaskInstanceServiceSpec extends Specification {
    ...
    def '测试 retry方法'() {
        ...
        def sagaTaskInstanceService = new SagaTaskInstanceServiceImpl(sagaTaskInstanceMapper, sagaInstanceMapper, null, null, null)
    ...
    def '测试 updateStatus的更新失败方法'() {
        ...
        def sagaTaskInstanceService = new SagaTaskInstanceServiceImpl(mockTaskInstanceMapper, mockInstanceMapper, null, transactionManager, null)
    ...
    def '测试 updateStatus的更新成功方法'() {
        ...
        def sagaTaskInstanceService = new SagaTaskInstanceServiceImpl(mockUpdateTaskInstanceMapper, mockInstanceMapper, mockJsonDataMapper, transactionManager, null)
