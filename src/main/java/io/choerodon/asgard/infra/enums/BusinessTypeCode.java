...
public enum BusinessTypeCode {
    ...
    VINDICATOR_CREATE_USER_FAILED("VINDICATOR_CREATE_USER_FAILED"),
    VINDICATOR_CREATE_ORGANIZATION_FAILED("VINDICATOR_CREATE_ORGANIZATION_FAILED"),
    VINDICATOR_CREATE_PROJECT_FAILED("VINDICATOR_CREATE_PROJECT_FAILED"),
