...
public class SagaInstanceEventPublisher {
    public static String SAGA_INSTANCE_TOPIC="saga_instance";
    public static String TAST_INSTANCE_PREFIX="TASK";
    public static String QUARTZ_INSTANCE_PREFIX="QUARTZ";
